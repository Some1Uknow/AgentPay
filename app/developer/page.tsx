...
export default function DeveloperPage() {
  return (
    <main className="premium-page developer-premium">
      ...
      <section className="page-hero"><div><span>For tool builders</span><h1>Monetize an MCP tool in one wrapper.</h1><p>Add x402 to your endpoint, publish metadata, and let buyer agents pay per call. Successful work builds reputation on Avalanche.</p></div><div className="badge-row"><ProtocolBadge type="x402" label="HTTP 402" /><ProtocolBadge type="usdc" label="USDC" /><ProtocolBadge type="avax" label="Fuji" /></div></section>
